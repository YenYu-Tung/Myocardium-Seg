...
def get_parser(argv):
    ...
    parser.add_argument("--model_dir", default="./checkpoints", type=str, help="directory to save the model checkpoints")
    ...
    parser.add_argument("--split_train_ratio", default=1.0, type=float, help="split train ratio")
    ...
    parser.add_argument("--strong_aug", action="store_true", help="enable extended augmentation ops")
    parser.add_argument("--use_amp", action="store_true", help="use torch.cuda.amp")
    ...
    parser.add_argument("--attn_drop_rate", default=0.0, type=float, help="attention dropout rate for transformer models")
    parser.add_argument("--dropout_path_rate", default=0.0, type=float, help="drop path rate (stochastic depth)")
    parser.add_argument("--grad_clip_norm", default=0.0, type=float, help="gradient clipping norm")
    parser.add_argument("--class_weights", type=float, nargs="+", default=None, help="class weights for loss")
    parser.add_argument("--adabelief_beta1", default=0.9, type=float, help="AdaBelief beta1")
    parser.add_argument("--adabelief_beta2", default=0.999, type=float, help="AdaBelief beta2")
    parser.add_argument("--adabelief_eps", default=1e-16, type=float, help="AdaBelief eps")
    parser.add_argument("--adabelief_weight_decouple", action="store_true", help="AdaBelief weight decouple")
    parser.add_argument("--no_adabelief_weight_decouple", dest="adabelief_weight_decouple", action="store_false", help="Disable AdaBelief weight decouple")
    parser.set_defaults(adabelief_weight_decouple=True)
    parser.add_argument("--adabelief_rectify", action="store_true", help="Use rectified update for AdaBelief")
    parser.add_argument("--no_adabelief_rectify", dest="adabelief_rectify", action="store_false", help="Disable rectified update for AdaBelief")
    parser.set_defaults(adabelief_rectify=True)
    parser.add_argument("--adabelief_fixed_decay", action="store_true", help="Use fixed decay for AdaBelief weight decouple")
    parser.add_argument("--adabelief_amsgrad", action="store_true", help="Enable AMSGrad variant for AdaBelief")
    ...
    parser.add_argument("--warmup_start_lr", default=0.0, type=float, help="starting LR for warmup schedulers")
    parser.add_argument("--eta_min", default=0.0, type=float, help="minimum LR for cosine schedulers")
